...
describe("Fuel Tank", function()
    ...
    describe("#update", function()
      describe("Fuel addition", function()
            it("should be able to add fuel", function()
              fuel_tank:update(10)
              fuel_tank:add_fuel(5)
              assert.is.equal(25, fuel_tank:get_fuel())
            end)

            it("should not be able to add fuel beyond max", function()
              fuel_tank:add_fuel(5)
              assert.is.equal(fuel_tank.max_fuel, fuel_tank:get_fuel())
            end)
      end)
    end)
